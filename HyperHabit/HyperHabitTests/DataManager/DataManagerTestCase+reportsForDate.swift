...
extension DataManagerTestCase {
    ...
    func test_reportsForDate() {
        ...
        XCTAssertEqual(sortReports([report1, report2]), sortReports(dataManager.reports))
        XCTAssertEqual([], dataManager.reportsForDate(NSDate()))
        ...
        XCTAssertEqual(sortReports([report1, report2, report3, report4]), sortReports(dataManager.reports))
        XCTAssertEqual(sortReports([report3, report4]), sortReports(dataManager.reportsForDate(NSDate())))
        ...
        XCTAssertEqual(sortReports([report1, report2, report3, report4, report5, report6]), sortReports(dataManager.reports))
        XCTAssertEqual(sortReports([report3, report4]), sortReports(dataManager.reportsForDate(NSDate())))
    }
}
